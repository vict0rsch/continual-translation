...
python train.py --dataroot $SLURM_TMPDIR --name base_cyclegan_WS --model cycle_gan --checkpoints_dir "/scratch/vsch/continual/checkpoints" --display_freq 1000 --batch_size 3
